...
def mapper():
    ...
    for line in sys.stdin:
    	# your code here 
        # If data is inappropriate size or first line is weather continue
    	# Have two strings fog and rain
    	# if data[14] = 0 then fog = nofog else fog = fog
    	# if data[15] = 0 then rain = norain else rain = rain
        fog = ""
        rain = ""
